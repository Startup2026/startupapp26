...
const resolveMediaUrl = (baseUrl: string, mediaPath?: string) => {
  if (!mediaPath) return "";
...
const getCommentAuthorName = (comment: any) => {
  ...
  return commentUser.username || commentUser.name || commentUser.email || "User";
};

const getCommentAuthorInitials = (comment: any) => {
      ...
      <div className="max-w-3xl mx-auto space-y-6 animate-fade-in">
        ...
        {post.media?.photo && (
          <Card className="overflow-hidden">
            <img
              src={resolveMediaUrl(BASE_URL, post.media.photo)}
        ...
        {post.media?.video && (
          <Card className="overflow-hidden">
            <CardContent className="p-0">
              <video
                src={resolveMediaUrl(BASE_URL, post.media.video)}
